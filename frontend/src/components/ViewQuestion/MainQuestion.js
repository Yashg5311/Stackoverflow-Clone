                ...
                <div className="comment">
                  {
                    questionData?.comments && questionData?.comments?.map((_qd) =>
                      <p>
                        {_qd?.comment} - {" "}
                        <span> {_qd?.user?.displayName ? _qd?.user?.displayName :
            ...
            questionData?.answerDetails.map((_q) => (
              <div key={_q?._id}
                ...
                <div className="question-answer">
                  ...
                  <div className="author">
                    <small> answered {new Date(_q?.created_at).toLocaleString()}</small>
                    <div className="author-details">
                      <Avatar src={_q?.user?.photo} />
                      <p>
                        {_q?.user?.displayName ? _q?.user?.displayName :
